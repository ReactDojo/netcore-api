...
namespace DemoProject.Web.Services
{
    ...
    public class TripsRequestGrpcService : TripsReqData.TripsReqDataBase
    {
        ...
        //public override async Task<GetTripsReqResponse> GetTripsReq(GetTripsReqRequest request,GetTripsReqResponse response, IServerStreamWriter<GetTripsResponse> responseStream, ServerCallContext context)
        //{
        //    try
        //    {
