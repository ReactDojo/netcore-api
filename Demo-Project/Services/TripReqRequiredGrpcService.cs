...
{
    public class TripReqRequiredGrpService : TripReqRequiredData.TripDataBase
    {
        ...
        public override async Task GetTripsReqRequired(GetTripsReqRequiredRequest request, IServerStreamWriter<GetTripsReqRequiredResponse> responseStream, ServerCallContext context)
        {
            try
            {
                ...
                for (var i = 0; i <= dataLimit - 1; i++)
                {
                    ...
                    await responseStream.WriteAsync(new GetTripsRequiredResponse
                    {
                            Id = item.Id,
        ...
        public override async Task<GetAllTripsReqRequiredResponse> GetAllTripsReqRequiredUnary(GetAllTripsReqRequiredRequest request, ServerCallContext context)
        {
            try
            {
                _logger.LogInformation("Incoming request for GetTrips");
